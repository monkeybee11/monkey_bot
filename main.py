...
@oimate.slash_command(name = "aquarium" , description = "look inside your aquraium")
...
async def throw(ctx,member:discord.Member):
    ...
    if users[str(user.id)]["snowball"] == 0:
        ...
        await ctx.respond(f"<@!{member.id}> WATCH OUT")
